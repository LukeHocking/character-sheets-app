                    ...
                    <form method="POST" action="/character/save">
                        ...
                        <div class="row">
                            ...
                            <div class="column p-1 w-25">
                                ...
                                <div name="level"></div>
                                <input id="level" type="number" class="form-control{{ $errors->has('level') ? ' is-invalid' : '' }}" name="level" value="1" required>
                                @if ($errors->has('level'))
                                    <span class="invalid-feedback" role="alert">
                        ...
                        <div class="row">
                            <div class="column p-1 w-25">
                                ...
                                <input id="hitPoints" type="number" class="form-control{{ $errors->has('hitPoints') ? ' is-invalid' : '' }}" name="hitPoints" value="10" required>
                            ...
                            <div class="column float-left p-1 m-1 border" style="width:15%">
                                <div>
                                    ...
                                    <input id="constitution" type="number" class="form-control{{ $errors->has('constitution') ? ' is-invalid' : '' }}" 
                                        name="constitution" value="0" required autofocus onchange="calculateAttributes()">
                                ...
                                <div>
                                    ...
                                    <input id="strength" type="number" class="form-control{{ $errors->has('strength') ? ' is-invalid' : '' }}" 
                                        name="strength" value="0" required autofocus onchange="calculateAttributes()">
                                ...
                                <div>
                                    ...
                                    <input id="dexterity" type="number" class="form-control{{ $errors->has('dexterity') ? ' is-invalid' : '' }}" 
                                        name="dexterity" value="0" required autofocus onchange="calculateAttributes()">
                                ...
                                <div>
                                    ...
                                    <input id="intelligence" type="number" class="form-control{{ $errors->has('intelligence') ? ' is-invalid' : '' }}" 
                                        name="intelligence" value="0" required autofocus onchange="calculateAttributes()">
                                ...
                                <div>
                                    ...
                                    <input id="wisdom" type="number" class="form-control{{ $errors->has('wisdom') ? ' is-invalid' : '' }}" 
                                        name="wisdom" value="0" required autofocus onchange="calculateAttributes()">
                                ...
                                <div>
                                    ...
                                    <input id="charisma" type="number" class="form-control{{ $errors->has('charisma') ? ' is-invalid' : '' }}" 
                                        name="charisma" value="0" required autofocus onchange="calculateAttributes()">
